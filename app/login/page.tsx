  ...
  return (
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{
          ...
          --white:#ffffff;--gray-50:#f9fafb;--gray-200:#e5e7eb;
      ...
      <nav className="auth-nav">
        ...
        <a href="/signup" style={{fontSize:'13px',fontWeight:600,padding:'7px 16px',borderRadius:'7px',border:'none',background:'var(--navy)',color:'var(--white)',textDecoration:'none'}}>Get Started</a>
      </nav>
      <div className="auth-wrap">
        <div className="auth-card">
          ...
          <div className="field">
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleLogin()} placeholder="you@company.com" />
          </div>
          <div className="field">
          ...
          <button className="btn-navy" onClick={handleLogin} disabled={loading || !email || !password}>
            {loading ? 'Signing in...' : 'Sign In'}
          </button>
          <div className="divider"><div className="divider-line"/><span className="divider-text">new here?</span><div className="divider-line"/></div>
          <p className="auth-switch"><a href="/signup">Create your account &rarr;</a></p>
        </div>
      </div>
    </>
  )
