        ...
        {!hasSubscription && (
          <div style={{background:'#0f1f3d',borderRadius:16,padding:'40px',display:'flex',alignItems:'center',gap:40,marginBottom:32,flexWrap:'wrap'}}>
            <div style={{flex:1,minWidth:280}}>
              ...
              <p style={{fontSize:14,color:'rgba(255,255,255,0.65)',lineHeight:1.7,marginBottom:24}}>The Homebuilding Maturity Assessment covers 53 items across 6 operational domains. Get your score, maturity level, and AI-powered roadmap in under 30 minutes.</p>
